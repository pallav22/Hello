        ...
        function($scope,$rootScope,$http, $window) {
            ...
            $scope.searchModel = function(searchProdcut1) {
                ...
                $http.get(
                    ...
                    function(response) {
                        ...
                        console.log($scope.searchProductModel);
            ...
            $scope.getValue = function(x, y, z) {
                ...
                for (var i = 0; i < $scope.SelectedValue.length; i++) {
                    ...
                    $scope.cost = parseFloat((($scope.SelectedValue[i].SP * 100) / (parseInt($scope.SelectedValue[i].VAT) + 100)).toFixed(2));
                    $scope.vatAmount =  parseFloat((($scope.SelectedValue[i].SP) - $scope.cost).toFixed(2));
                    ...
                    $scope.TotalVat = $scope.vatAmount +
                        $scope.TotalVat;
                    $scope.costTotal = $scope.cost + $scope.costTotal;
